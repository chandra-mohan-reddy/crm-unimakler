...
function Components() {
                ...
                <Table className="align-items-center table-flush">
                  ...
                  <tbody className="list">
                    <tr>
                      ...
                      <td scope="row">User One</td>
                      <td scope="row">Lead Executive</td>
                      <td scope="row">9898787878</td>
                    ...
                    <tr>
                      ...
                      <td scope="row">User Two</td>
                      <td scope="row">Sales Executive</td>
                      <td scope="row">9898787878</td>
                      <td scope="row">usertwo@gmail.com</td>
                      <td className="text-right">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            className="btn-icon-only text-light"
                ...
                <Table className="align-items-center table-flush">
                  ...
                  <tbody className="list">
                    <tr>
                      ...
                      <td scope="row">Builder name</td>
                      <td scope="row">Hyderabad</td>
                      <td className="text-right">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            className="btn-icon-only text-light"
  ...
  return (
    <>
      <SimpleHeader name="Add Franchise" parentName="Franchise" />
