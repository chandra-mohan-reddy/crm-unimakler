...
function Sortable() {
  ...
  return (
    <>
      <SimpleHeader name="Status Type Mapping" parentName="Master" />
                  ...
                  <Table className="align-items-center table-flush">
                    ...
                    <tbody className="list">
                      <tr>
                        ...
                        <td scope="row">Status From</td>
                        <td scope="row">Status To</td>
                        <td>
