...
function State() {
  ...
  React.useEffect(() => {
    const getStatesList = async () => {
      ...
      try {
        ...
        const response = await masterServices.getStates();
  ...
  return (
    <>
      <SimpleHeader name="State List" parentName="State" />
                ...
                <div className="table-responsive" ref={firstListRef}>
                  <Table className="align-items-center table-flush">
                    ...
                    <tbody className="list">
                      {loading ? (
                        <tr><td colSpan={5}><LoaderHorizontal /></td></tr>
                      ) : (
                        data.map((item, index) => {
                          return (
                            <tr>
                              ...
                              <td scope="row" className="state">{item.state_name}</td>
